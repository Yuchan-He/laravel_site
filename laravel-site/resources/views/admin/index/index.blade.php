...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="{{route('front.article.index')}}">Tiny Happiness</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href=""></a> 
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						<li>
							<a href="{{route('admin.logout')}}">ログアウト
							</a>
						</li>
						<li>
							<a href="javascript:;" onClick="myselfinfo()">個人情報
							</a>
						</li>
